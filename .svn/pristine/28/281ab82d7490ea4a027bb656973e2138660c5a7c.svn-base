{{-- TODO: Remember to remove cachebreak from production version --}}
<link rel="stylesheet" href="/css/foundation.css?version={{ time(); }}" />
<link rel="stylesheet" href="/css/flexslider.css?version={{ time(); }}" />
<link rel="stylesheet" href="/css/icons.css?version={{ time(); }}" />
...
<link rel="stylesheet" href="/css/responsive.css?version={{ time(); }}" />
<link rel="stylesheet" href="/css/mobile-master.css?version={{ time(); }}"/>
